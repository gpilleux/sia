...
- **Specialized Sub-Agents** (SIA, Repository Guardian, Requirement Translator, etc.)
...
- **Supreme SPR** (auto-generation and update of the repository mental map)
...
```yaml
# .sia.detected.yaml (auto-generated by SIA)
discovery_rules:
  meta_system:
    primary: "sia/core/SUPER_AGENT.md"
    
  project_spr:
    pattern: ".agents/{project_name}.md"
    examples:
      - ".agents/dipres_analyzer.md"  # Example
      - ".agents/erp.md"               # Example
    fallback: ".agents/README.md"
